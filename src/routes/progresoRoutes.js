...
router.get("/:userId", async (req, res) => {
  try {
    ...
    // ✅ Ya NO necesitamos interaccion_id.conversacion
    ...
    const resultadosSemana = todosResultados.filter(
      (r) => r.fecha && new Date(r.fecha) >= haceUnaSemana
    );
